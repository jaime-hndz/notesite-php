<?php
  ...
  if ($_SERVER["REQUEST_METHOD"]== "POST") {
    ...
    if (isset($_POST['curso'])) {
      ...
      $seccion_select = $_POST['curso'];
      $_SESSION["seccion_actual"]= $seccion_select;

    }else {

      if (isset($_SESSION["seccion_actual"])) {
        $seccion_select = $_SESSION["seccion_actual"];
      }else {
        $seccion_select = "-";
      }
    }
    ...
    if (isset($_POST['materia'])) {
      ...
      $materia_select = $_POST['materia'];
      $_SESSION["materia_actual"]= $materia_select;

    }else {

      if (isset($_SESSION["materia_actual"])) {
        $materia_select = $_SESSION["materia_actual"];
      }else {
        $materia_select = $row['materia'];
      }
    }
        ...
        if (strlen($contraseñaNueva) > 5) {
          ...
          if ($contraseñaNueva == $contraseñaNueva2) {
            ...
            if ((empty($error_pass3)) && (empty($error_pass)) && (empty($error_pass2))) {
              ...
              $insertar="UPDATE users_teacher SET password='".$ultipass."'";
    ...
    if (isset($_FILES['avatar'])) {
      ...
      if (is_uploaded_file($ruta1)) {
        $destino1 = "perfiles/t".$name;
        copy($ruta1, $destino1);
      }

     $sql = "UPDATE users_teacher SET avatar = '".$destino1."' WHERE id ='".$row['id']."'";
...
<ul>
    <li><a href="index_teacher.php"><i class="fas fa-house-user"></i>  Inicio</a></li>
    <li>
